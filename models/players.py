...
class Players(Base):
    ...
    login_time = Column(BigInteger(), comment="最后登录时间")
    ip = Column(BigInteger(), comment="登录 IP")
    share_time = Column(BigInteger())
    get_diamond = Column(Integer())
